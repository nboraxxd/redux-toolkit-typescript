 ...
 * ✅ Khi dùng function kiểm tra kiểu này, ngoài việc kiểm tra về mặc logic cấu trúc, nó còn chuyển kiểu
 *
 * So sánh với phương pháp ép kiểu "Type Assertions" thì ép kiểu giúp chúng ta đúng về mặc Type, chưa chắc về logic
 */
...
/**
 * Thu hẹp error có kiểu không xác định về lỗi liên quan đến POST PUT không đúng field (EntityError)
 */
